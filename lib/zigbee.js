...
module.exports = class Zigbee {
    ...
    static #DEVICES = [
        ...
        },
        {
            ...
            'lumi_spec': [
                ...
                // [undefined, undefined, 'action', 'sensor'],
            ]
        },
        {
        ...
        },
        {
            ...
            'lumi_spec': [
                [undefined, 'alive', 'available'],
                ['8.0.2007', 'lqi', 'link_quality'],
                ['0.1.85', undefined, 'bed_activity'],
                ['0.2.85', undefined, 'tilt_angle'],
                ['0.3.85', undefined, 'vibrate_intensity'],
                ['13.1.85', undefined, 'vibration'],
                ['14.1.85', undefined, 'vibration_level'],
                ['8.0.2008', 'voltage', 'voltage'],
                ['8.0.2008', 'voltage', 'battery'],
                // [undefined, undefined, 'action', 'sensor']
            ]
        ...
        },
        {
            ...
            'lumi_spec': [
                [undefined, 'alive', 'available'],
                ['8.0.2007', 'lqi', 'link_quality'],
                ['1.1.85', 'curtain_level', 'position'],
                // ['14.2.85', undefined, 'motor', 'cover'],
                ['14.3.85', 'cfg_param', 'cfg_param'],
                ['14.4.85', 'run_state', 'run_state'],
            ]
        },
        {
        ...
        },
        {
            ...
            'lumi_spec': [
                ...
                ['3.2.85', undefined, 'current_temperature'],
                // ['14.2.85', 'ac_state', 'climate', 'climate'],
                ['14.8.85', undefined, 'mode'],
                ['14.9.85', undefined, 'target_temperature'],
                ['14.10.85', undefined, 'fan_mode'],
            ]
        },
        {
    ...
    static getDeviceByModel(model) {
        ...
        if (device != undefined) {
            ...
            return {
                'manufacturer': desc[0],
                'name': desc.length > 2 ? desc[2] : model,
                'model': model,
