    ...
    static #DEVICES = [
        ...
        },
        {
            ...
            'spec': [
                ...
                //['3.1.85', undefined, Occupancy, [], [DefaultParser]],
                ['3.1.85', 'ismotion', IsMotion, [], [MotionParser]],
                ['8.0.2008', 'voltage', Voltage, [], [VoltageParser]],
                ['8.0.2008', 'voltage', Battery, [], [BatteryParser]],
        ...
        },
        {
            ...
            'spec': [
                ...
                ['13.1.85', 'vibration', IsVibration,[], [VibrationParser]], // TODO: Klaus
                ['13.1.85', 'drop', Drop,[], [DropParser]], // TODO: Klaus
                ['0.1.85', 'bed_activity', BedActivity, [], [DefaultParser]], // TODO: Klaus
                ['0.2.85', 'tilt_angle', TiltAngle,[],[DefaultParser]], // TODO: Klaus
                ['8.0.2008', 'voltage', Voltage, [], [VoltageParser]],
                ['8.0.2008', 'voltage', Battery, [], [BatteryParser]],
                [undefined, undefined, DebugOutput, [], [DebugOutputParser]],
                [undefined, undefined, MessagesStat, [], [MessagesStatParser]],
...
//Klaus START
/* Parser functions for vibration sensor*/
function VibrationParser() {
    return val => val > 0 ? 1 : 0;
}
function DropParser() {
    return val => val > 1 ? 1 : 0;
}
function MotionParser() {
    return val => val == 1 ? 1 : 0;
}
//Klaus END
...
function TemperatureParser(model) {
    //Klaus START
    if (['lumi.weather'].includes(model) == true)
      return val => val / 100;
    else /*Klaus END*/if (['lumi.airmonitor.acn01', 'lumi.sensor_ht.agl02'].includes(model) == false)
        return val => Math.round(val / 100);
    else
        return val => val;
}
