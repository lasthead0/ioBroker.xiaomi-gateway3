...
class Gateway3 extends XiaomiDevice {
    ...
    async initialize(config, cb) {
        ...
        const {telnetCmd, gwEnablePublicMqtt, gwLockFirmware, gwDisableBuzzer} = config;
        ...
        if (await this._checkPort(23) != true && await this._enableTelnet(openTelnetCmd) != true) {
            ...
            /* Applying patches and run daemon_miio.sh */
            ...
            /* Getting and installing devices */
