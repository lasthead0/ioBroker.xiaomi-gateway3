...
class StateClass {
    ...
    get stateObject() {
        /* */
        const {name, role = 'state', type, read, write, unit, min, max, states, custom} = this.stateCommon;
...
/* */
module.exports = {
    Action: class extends StateClass {
        stateName = 'action';
        stateCommon = {
            name: 'Action',
            role: 'state',
    ...
    Trigger: class extends StateClass {
        stateName = 'trigger';
        stateCommon = {
            name: 'Trigger',
            role: 'state',
    ...
    VibrationSensitivity: class extends StateClass {
        stateName = 'vibration_sensitivity';
        stateCommon = {
            name: 'Vibration sensitivity',
            role: 'state',
            type: 'number',
            states: {1: 'high', 11: 'medium', 21: 'low'}
        };
